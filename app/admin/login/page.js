...
// Redesigned: focused, high‑contrast admin login with error state, keyboard/accessibility,
// subtle card, and password visibility toggle (no JS libs). Pure .jsx/.js compatible.
...
export default function AdminLoginPage() {
    ...
    // Read ?error from URL to show a friendly message
    let hasError = false;
                ...
                <form action="/admin/login/submit" method="post" className="space-y-4">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                            Tip: Do not share this password.
                        </p>
                    </div>

                    <button
                        type="submit"
                        className="w-full rounded-[5px] bg-[#FF7302] px-4 py-3 text-base font-semibold text-black hover:opacity-90"
                    >
                        Sign in
                    </button>
                </form>
